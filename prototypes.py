...
def k_shot_test(config, val_loader, val_bms, model, optimizer):
    """
...
if __name__ == "__main__":
    ...
    val_bms  = [batchmanager2] # IBM
    test_bms = [batchmanager5] # SICK 
    ...
    if not os.path.exists("csv"):
        os.makedirs("csv")
    csv_file_name = os.path.join("csv", "lr"+str(config.lr) + 
    ...
    with open(csv_file_name, "w", newline= "") as file:
        ...
        write_list = []
        for i in range(1, config.nr_val_experiments):
            write_list.append(i)
